 ...
 */
class TipoEspacio extends MyActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(Espacio::class, ['tipo_espacio_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\models\query\TipoEspacioQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\query\TipoEspacioQuery(get_called_class());
    }
     ...
     * @return @Array.
     */
    public static function getArrayTipoEspacio($order = 'nombre')
    {
