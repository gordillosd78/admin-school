 ...
 */
class Parentesco extends MyActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return \app\models\query\ParentescoQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\query\ParentescoQuery(get_called_class());
    }
     ...
     * @return @Array.
     */
    public static function getArrayParentesco($order = 'nombre')
    {
